...
delay2phase : delay2phase.cpp
	g++ delay2phase.cpp -o delay2phase  -I $(SRCDIR)/cmn/baselib/ -I ../fitslib/ -I ../speclib/ ${HDF5_LIB} ../speclib/libspeclib.a -lfftw3 $(COMMON_LIBS) $(OPT) -D_UNIX
...
hdf5corr2others : hdf5corr2others.cpp hdf5_commons.cpp eda1_tpm_coefficients.cpp eda2_tpm_coefficients.cpp
	g++ hdf5corr2others.cpp hdf5_commons.cpp eda1_tpm_coefficients.cpp eda2_tpm_coefficients.cpp $(OPT) -o hdf5corr2others -I ${HDF5_DIR} -I $(SRCDIR)/cmn/baselib/ -I ../fitslib/ -I ../speclib/ ${HDF5_LIB} ../speclib/libspeclib.a -lfftw3 $(COMMON_LIBS) $(OPT) -D_UNIX
# DEBUG :
