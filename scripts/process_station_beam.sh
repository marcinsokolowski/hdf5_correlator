...
echo "python $beam_scripts_path/plot_power_vs_time.py ${tag}_power_vs_time_ch4 # ${freq_channel}"
python $beam_scripts_path/plot_power_vs_time.py ${tag}_power_vs_time_ch4 # ${freq_channel}
