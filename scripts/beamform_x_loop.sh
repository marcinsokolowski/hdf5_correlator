...
do
   ...
   while [[ $az -le 360 ]];
   do
      echo "beamform_all.sh \"-C 1 -X $delays -K ($az,$elev) -E antenna_locations_eda2.txt -e Geraldton_az${az}el${elev}deg_timeseries_X -H $freq_mhz\" 20200225_24hours_eda2_256ant_ch126_GeroBeam_az${az}el${elev}deg_X.txt - hdf5_list > az${az}el${elev}deg_x.out 2>&1"
      beamform_all.sh "-C 1 -X $delays -K ($az,$elev) -E antenna_locations_eda2.txt -e Geraldton_az${az}el${elev}deg_timeseries_X -H $freq_mhz" 20200225_24hours_eda2_256ant_ch126_GeroBeam_az${az}el${elev}deg_X.txt - hdf5_list > az${az}el${elev}deg_x.out 2>&1
