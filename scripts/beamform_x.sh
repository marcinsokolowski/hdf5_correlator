...
# az=153
# el=70.8457
# echo "beamform_all.sh \"-C 1 -X $delays -K ($az,$el) -E antenna_locations_eda2.txt -e Geraldton_az${az}el${el}deg_timeseries_X -H 98.4375\" 20200225_24hours_eda2_256ant_ch126_GeroBeam_az${az}el${el}deg_X.txt - hdf5_list > az${az}el${el}deg_x.out 2>&1"
# beamform_all.sh "-C 1 -X $delays -K ($az,$el) -E antenna_locations_eda2.txt -e Geraldton_az${az}el${el}deg_timeseries_X -H 98.4375" 20200225_24hours_eda2_256ant_ch126_GeroBeam_az${az}el${el}deg_X.txt - hdf5_list > az${az}el${el}deg_x.out 2>&1
...
el=70.846771
freq_mhz=98.4375
echo "beamform_all.sh \"-C 1 -X $delays -K ($az,$el) -E antenna_locations_eda2.txt -e Geraldton_az${az}el${el}deg_timeseries_X -H $freq_mhz\" 20200225_24hours_eda2_256ant_ch126_GeroBeam_az${az}el${el}deg_X.txt - hdf5_list > az${az}el${el}deg_x.out 2>&1"
beamform_all.sh "-C 1 -X $delays -K ($az,$el) -E antenna_locations_eda2.txt -e Geraldton_az${az}el${el}deg_timeseries_X -H $freq_mhz" 20200225_24hours_eda2_256ant_ch126_GeroBeam_az${az}el${el}deg_X.txt - hdf5_list > az${az}el${el}deg_x.out 2>&1
